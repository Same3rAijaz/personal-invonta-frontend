import { Box, Button, Paper, Typography, Grid, TextField, Divider } from "@mui/material";
...
export default function AttendanceCreate() {
  ...
  const { register, handleSubmit, watch } = useForm({ defaultValues: { exportMonth: "" } });
      ...
      <Paper sx={{ p: 3, borderRadius: 3, boxShadow: "0 18px 40px rgba(15,23,42,0.08)" }}>
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} md={8}>
            <TextField fullWidth label="Export Month (YYYY-MM)" {...register("exportMonth")} />
          </Grid>
